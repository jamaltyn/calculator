...
def make_solution_button(operation):
    return tk.Button(text=operation, bd=5, font="Arial 13", fg="red", command=calculate_digit)



make_operation_digit_button("+").grid(row=2, column=3, stick="wens", padx=5, pady=5)
make_operation_digit_button("-").grid(row=1, column=3, sticky="wens", padx=5, pady=5)
make_operation_digit_button("*").grid(row=4, column=3, sticky="wens", padx=5, pady=5)
make_operation_digit_button("/").grid(row=3, column=3, sticky="wens", padx=5, pady=5)

make_solution_button("=").grid(row=4, column=1, stick="wens", padx=5, pady=5)
...
clear_button = tk.Button(text="C", bd=5, fg="red", font="Arial 13", command=remove_digit )

clear_button.grid(row=4, column=2, stick="wens", padx=5, pady=5)
